...
//		Q q=new Q();
//		q.testMulti();
    	String[] a = PinyinHelper.toHanyuPinyinStringArray(' ');
    	System.out.println(a==null);
    	a = PinyinHelper.toHanyuPinyinStringArray('D');
    	System.out.println(a[0].substring(0, a[0].length()-1));
	}
